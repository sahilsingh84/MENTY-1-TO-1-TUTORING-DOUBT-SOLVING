...
const LearningGridArray = [
  {
    ...
    description:  "Menty partners with more than 275+ leading universities and companies to bring flexible, affordable, job-relevant online learning to individuals and organizations worldwide.",
    BtnText: "Learn More",
    BtnLink: "/",
  },
  {
  ...
  },
  {
    ...
    description: "Menty partners with more than 275+ leading universities and companies to bring",   
  },
  {
    order: 3,
            ...
            { LearningGridArray.map((card, i) => {
                return (
                  <div key = {i} className = {`${i === 0 && "xl:col-span-2 xl:h-[294px]"}  ${card.order === 3 && "xl:col-start-2"}  
                    ...
                    { card.order < 0 ? (
                                      <div className="xl:w-[90%] flex flex-col gap-3 pb-10 xl:pb-0 subCustomBoxShadow">
                                      ...
                                      <div className="p-8 flex flex-col gap-8 subCustomBoxShadow">
                                        <h1 className="text-richblack-500 font-bold text-lg">{card.heading}</h1>
                                        <p className="text-richblack-300 font-medium">  {card.description}  </p>     
                                      </div>
                                    )
                    }
